...
\subfile{sections/00_intro.tex}


\chapter{The Drude Theory of Metals}
\subfile{sections/01_drude.tex}
\renewcommand{\thesubsubsection}{\thesubsection.\alph{subsubsection})}
\subfile{problems/01_drude_problems.tex}
\renewcommand{\thesubsubsection}{\thesubsection.\arabic{subsubsection}}

\chapter{The Sommerfeld Theory of Metals}
\subfile{sections/02_sommerfeld.tex}

\chapter{Quantum Transport}
\subfile{sections/03_quantum_trans.tex}
